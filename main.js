const app = new Vue ({
    ...
    methods: {
        ...
        dividirCuenta: function() {
            ...
            for(i in reciben){
                for(x in reciben[i].final){
                    if(reciben[i].final[x].monto < 0){
                        reciben[i].final[x].monto = reciben[i].final[x].monto*-1;
                    };
                };
                this.reciben.push(reciben[i]);
            };
            for(i in ponen){
                for(x in ponen[i].final){
                    if(ponen[i].final[x].monto < 0){
                        ponen[i].final[x].monto = ponen[i].final[x].monto*-1;
                    };
            };
